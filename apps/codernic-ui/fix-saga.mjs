...
const replacement = '} else if (msg.type === \\'ac:chat-error\\') {' +
  ...
  '  yield put(appendMessage({ id: pendingId, role: \\'assistant\\', text: \\'❌ **Error**: \\' + text, streaming: false, toolCalls: [] }));' +
  '} else {' +
  '  yield put(updateAssistantMessage({ id: pendingId, chunk: \\'❌ **Error**: \\' + text, done: true }));' +
  '}' +
