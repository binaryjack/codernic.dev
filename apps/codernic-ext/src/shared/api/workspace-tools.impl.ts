...
export async function toolRagtimeSemanticSearch(
  input: Record<string, unknown>,
  mcpClient?: import('../mcp').McpClientInstance,
): Promise<string> {
...
export async function toolSearchWorkspaceSymbols(
  input: Record<string, unknown>,
  mcpClient?: import('../mcp').McpClientInstance,
): Promise<string> {
  const query = String(input['query'] ?? '').trim();
...
export async function toolGrepProject(
  input: Record<string, unknown>,
...
export async function toolWriteFile(
  ...
  if (rel.includes('.codernic/config/codernic/rules/')) {
...
export async function toolCreateDirectory(
  input: Record<string, unknown>,
  workspaceRoot: string,
  mcpClient?: import('../mcp').McpClientInstance,
): Promise<string> {
...
export async function toolRunTerminal(
  input: Record<string, unknown>,
  workspaceRoot: string,
  mcpClient?: import('../mcp').McpClientInstance,
...
export async function toolReadProjectMemory(workspaceRoot: string): Promise<string> {
  const intelligenceDir = path.join(workspaceRoot, '.codernic', 'config', 'intelligence');
...
export async function toolWriteProjectMemory(
  input: Record<string, unknown>,
  workspaceRoot: string,
): Promise<string> {
