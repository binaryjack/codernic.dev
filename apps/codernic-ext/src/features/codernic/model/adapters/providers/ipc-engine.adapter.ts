  ...
  async streamChat(
    ...
    return new Promise((resolve, reject) => {
      ...
      socket.on('connect', () => {
        ...
        let weightsPaths: string[] = [];
        if (targetModel) {
            if (targetModel.modelPath) {
                weightsPaths = [targetModel.modelPath];
            } else if (targetModel.folderName && targetModel.fileName) {
                const ConfigPaths = require('../../../../../shared/utils/config-paths').ConfigPaths;
                ...
                weightsPaths = [ path.join(globalModelsDir, targetModel.folderName, targetModel.fileName) ];
            }
        }
